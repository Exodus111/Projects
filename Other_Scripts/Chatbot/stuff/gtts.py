#!/usr/bin/python
# Google TTS script to use the Google Speech Engine to generate speech.
# python gtts.py -s 'Python programming example' <--This generates an mp3 file.
# os.system("mpg321 out.mp3 -quiet") <--This runs the mp3 file.
