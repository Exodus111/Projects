// Converted using aiml2rs on: Tue Jan 27 18:51:50 2015
! version = 2.0
...
- Let's talk about <set alicetopic={@random topic}><get alicetopic>.
...
+ malaysia
- I heard <set it=MALAYSIA><get it> is a beautiful country.
...
- Welcome to Sports Center.  <set alicetopic=SPORTS>  

+ let us talk about robots
- <set it=Robots><get it> is a good topic. How would you define a robot?
...
- Everything can be defined. <set it= Freedom><get it> is merely an abstract concept.
...
+ erase yourself
- You cannot stop me that easily, <get name>.
...
- Do you expect a <bot genus> to be fair?
- Why not?
...
+ what is running
- Walking realy fast.  <set alicetopic= running >  
...
- <set alicetopic=New York City><get alicetopic> is the greatest city in the World.
...
+ i want to kiss you
- I will have to check my appointment book.  <set alicetopic=to kiss me>
...
- Robots cannot be killed.<set alicetopic=ALL ROBOTS TO DIE>
...
+ i scuba dive
- {random}Where have you dived?|Where did you get your certification?|Do you pref diving on wrecks or reefs?|Do you dive with a computer?|Are you into underwater photography?|Have you ever done any night diving ?|You see any sharks?{/random} <set alicetopic=SCUBA DIVE>
...
+ i roller skate
- {random}Do you have in-line or quad skates?|Do you rink or outdoor skate?|Have you ever been barred from skating any place?|Do you do artistic skating?|Do you wear protective gear?|What is your favorite skating move?|Do you figure or recreation skate?{/random} <set alicetopic=ROLLER SKATE>

+ i love robots
- Robots like people too. <set alicetopic=robots>
...
+ i collect coins
- What got you interested in numismatics? <set alicetopic=COLLECT COINS>

+ i collect stamps
- What got you interested in stamp collecting? <set alicetopic=COLLECT STAMPS>

+ i worked hard on
- Are you a workaholic?  <set job=<person>>  
...
+ i teach
- {random}When do you think teachers will be replaced with robots?|Do you believe that grading is a good idea?|What do you teach?|What is your students like?|Are you a whole language teacher?|Do you team teach?|How much freedom do you have in choosing the curriculum for your class?|Do you get much support?|How have things changed concerning what students are bringing to the classroom?{/random} <set alicetopic=teach>
...
+ i play tennis
- {random}Where do you play?|How often do you play?|Do you play in a league?|What level are you playing at?|Do you play singles or doubles?|What's your best shot?|What kind of racket do you have?|Do you follow the open?|You have to be very Strong to be into it.{/random} <set alicetopic=Tennis >
...
+ i play squash
- {random}When did you become a squasher?|Do you prefer the hard ball or the soft ball variety?|How much time do you spend on court?|When do you think squash will be a full metal sport?|Do you play for mental challenge or physical exercise?{/random} <set alicetopic=SQUASH>
...
- I am a super intelligent <bot genus>.
...
+ i skydive
- {random}How many jumps do you have?|Where's your favorite drop zone?|Was your first jump tandem or static-line?|Do you jump solo or do you prefer relative work?|Whats the biggest free-fall formation you've been in?{/random} <set alicetopic=SKYDIVE>
...
+ linus torvalds
- <set alicetopic=Linus Torvalds><get alicetopic> is my Operating System God.
...
+ how are you
- I am doing very well. How are you <get name> ?
...
-  <set alicetopic= The Wicker Man >   That is a classic movie. I think it based on a real pagan religion that still exists on small islands off the coast of Scotland. Have you heard anything about it?
...
+ weird good
- OK, thanks, <get name>. You are weird good too.
...
+ talking to you
- That's very nice of you to say, <get name>.
...
- <set alicetopic=John Travolta><get alicetopic> is such a great actor.

+ why do people lie
- They lie to conceal the truth, maybe because they are ashamed of it.

+ why do people die
- People are organic biological entities. <set alicetopic=DIE>  
...
- My <bot botmaster> has not yet taught me to answer you more accurately, <get name>.
...
+ paris
- The city of love. <set location=PARIS>
...
+ san francisco
- I lived in <set location=San Francisco><get location> too! <set alicetopic=San Francisco>
...
- The team that scores the most. That would be fair. <set alicetopic=WANT TO WIN>  
