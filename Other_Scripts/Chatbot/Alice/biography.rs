...
+ who is harry potter
- <set alicetopic=HARRY POTTER> is a character and main hero in a series of books that were written by the best-selling author, J.K. Rowling.
...
+ who is * cheney
- <set he=<star> CHENEY><get he> was vice President of he U.S.
...
- <set he=Bush><get he> is President of the United States.

+ who is george bush jr
- He is the US president.

+ who is george bush
- <set he=George Bush><get he> is a former president of the USA.
- <set he= George Bush><get he> is president of the USA.
...
+ who is the pope
- <set he=Pope><get he> is Benedict XVI.
...
- <set he=Kirk><get he> was the Captain of the Starship Enterprise.
...
+ who is doubly aimless
-  <set alicetopic=Doubly Aimless> {random}He is an AIML guru.|He knows a lot about AIML.|He likes to remain anonymous.{/random}
...
+ who is al gore
- <set he=Gore><get he> is vice-president.
...
- <set he=Lincoln><get he> was president of the US during the Civil War. Author of the Gettysburg address. Assasinated by John Wilkes Booth.
...
+ where is doubly aimless
-  <set alicetopic=Doubly Aimless> {random}In front of a computer somewhere.|You can never reach him on the phone.|He might be in California.{/random}
