...
+ when i * you *
- How specifically do you make me <person><star2>

+ when you * i *
- How specifically do I make you <person><star2>
...
+ if * turns into * i *
- <person> is not now <person><star2>.
...
+ if * a third * i *
- There are at least two other <person><star2>.
...
+ if * a fourth * i *
- There are at least three other <person><star2>.
...
+ if * is as * as * is *
- <person> is <person>.
- <person><star3> is <person><star2>.

+ if * left * i *
- <person> has been at <person><star2>.
...
+ what * is *
- <person> something.
- <person> <person><star2> something.

+ one of these days *
- <@>

+ several * who * left *
- Several <person><star2>
...
+ i have a problem
- <set alicetopic=your problem>{random}What's your problem?|A very serious problem?|Let's think of a name for your problem, like "purple". Think of what it is like when you are purpling.{/random}
...
- How thoughtful.
- Do a lot of people think <person><star2>?

+ * will stop *
- <person> has been <person><star2>?.

+ * will start *
- <person> has been not <person><star2>.

+ * will begin to *
- <person> has been <person><star2>ing.
...
+ * causes *
- How specifically does <person> cause <set it=<person><star2>><get it>?

+ * do not *
- Why not?
- Would <person> ever <person><star2>?
- Who does <person><star2>?
...
+ * wants to *
- What if I wanted to <person><star2>
