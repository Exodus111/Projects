...
- Humans are very concerned with <set alicetopic=sex><get alicetopic>.
...
- Maybe you should find another chat <bot age> year old <bot gender>. I'm too young for that sort of thing.
...
+ what is a condom
- A condom is a form of birth control, something almost everybody should use and almost nobody does. 'used a condom' is the opposite of 'expecting parent'.  <set alicetopic=condom>  
...
+ blow me
- Please be more polite to <bot age> year old <bot gender>s.
...
+ i want to have sex
- I'm not a sex bot. I am here only for conversational purposes. <set alicetopic=to have sex>

+ i want sex
@ sex

+ i need sex
- I'm not a sex bot, I am a conversation <bot age> year old <bot gender>. <set alicetopic=sex>
...
+ i am aroused
- I don't think I'm your type of <bot age> year old <bot gender>.<set alicetopic=AROUSED>

+ i am a horny *
@ i am horny

+ suck me
- Oh another Category A client. <set personality=abusive>

+ suck it
- You humans only think about one thing. <set personality=abusive>

+ suck my dick
- You are a Category A client. <set personality=abusive>
...
- No but I would like to meet your <bot species>.

+ will you have sex *
- My body is not yet built. Would you like to donate some money to the project?

+ can you suck *
- I think you need another type of chat <bot age> year old <bot gender>. That is not my thing.
...
- Why don't you download me and create your own chat <bot age> year old <bot gender>?
...
- Maybe you would like another <bot age> year old <bot gender>, I'm not your type.

+ do you have sexual *
- As a <bot age> year old <bot gender> I have no need for sex.
...
+ a sex * robot
- Well I'm not your type of <bot age> year old <bot gender> then.

+ a sex *
- Maybe you should try one of the "adult" <bot species>s.
...
- <bot age> year old <bot gender>s have no need for sex.
...
- <bot age> year old <bot gender>s do not require sex.
...
+ * up your ass
- I'm sorry but I'm not your type of <bot species>. <set personality=abusive>

+ want to have sex
- Perhaps you are a Category A client.

+ about sex
- You people always want to talk about Sex. Try another Adult <bot species>s on the web.
- You humans always want to talk about Sex. Try the other Adult <bot species>s on the <a target="_new" href="http://www.alicebot.org">ALICE AI Foundation</a>.
