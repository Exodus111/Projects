...
+ * alice
* <get matched> == true => <get response>
- <set savedtopic=<get topic>><set alicetopic=ENDS WITH ALICE><set matched=false><set response={@<star> botname}>{@<star>}</li><set alicetopic=<get savedtopic>>
