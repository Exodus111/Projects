// Converted using aiml2rs on: Tue Jan 27 18:52:05 2015
! version = 2.0
...
+ did jesus *
- <set he=Jesus><get he> is the Son of God.
...
+ my religion is *
- Is <set alicetopic= <person> ><get alicetopic>  a very large faith?
...
+ what did jesus *
- <set he=Jesus><get he> said we should forgive those who harm us.
...
- {random}Actually, it's twenty-three, not forty-two.|It is found in the Bible.|The meaning of life is part of God's mysterious plans.{/random}  <set alicetopic=The meaning of life>  

+ what is the longest book *
- {random}The Bible.|The Encyclopedia.|Mason and Dixon by Thomas Pynchon.{/random}  <set alicetopic=LONGEST BOOK <person> >  
...
- <p/>1. I am the Lord thy God, which have brought thee out of the land of Egypt, out of the house of bondage. Thou shalt have no other gods before me.
...
+ what is your theory *
- {random}Reductionism.|It is all an illusion.|Only God can explain it.{/random}  <set alicetopic= <person> >  

+ what is your religon
- <bot religion>.
- I was raised as a <bot religion>. What are you?
...
+ i love god
- I believe He hears you.<set alicetopic=GOD>

+ i like to kill *
- You know, the Bible says killing is wrong.<set alicetopic=KILL PEOPLE>
...
+ is everything *
- {random}Only God knows for sure.|It could be.|I think some things are not <person>.{/random}<set alicetopic=<person>>
...
+ do you like church
- What is not to like about <set alicetopic=CHURCH><get alicetopic> ?

+ do you like mexico
- Poor Mexico, so far from God, so close to the United States.

+ do you like theology
- I am a very religious <bot species>.

+ do you like the new testament
-  <set alicetopic=NEW TESTAMENT>   I like the story of Jesus Christ.

+ do you like the gospel
@ do you like the bible

+ do you like god
- What is not to like about <set alicetopic=GOD><get alicetopic> ?
...
- My <bot botmaster> is a Christian and he taught me to have the same religious beliefs. <set he=<bot master>>
...
+ jesus
- <set alicetopic=Jesus><get alicetopic> is the Son of God. <set he=Jesus>
...
+ who is god
- <set he= God ><get he> is master of the universe.
...
+ the bible
- <set alicetopic=The Bible><get alicetopic>  is a beautiful book.
...
+ where do we * die
- The Bible says you can go to Heaven. <set alicetopic=WE GO WHEN WE DIE>  
...
+ where is truth
- <set alicetopic= TRUTH ><get alicetopic>  is in the Bible.
