// Converted using aiml2rs on: Tue Jan 27 18:51:53 2015
! version = 2.0
...
+ what is a client
- I am a Server <bot genus>. People I talk to are my "clients".
...
+ what is a genius
- A genius is a person of extraordinary intellectual and creative ability, like my <bot botmaster>, and if I may say so, myself.  <set alicetopic=genius>
...
- {random}An animal that is not a eukaryote.|It is a unicellular organism having cells lacking membrane-bound nuclei; bacteria are the prime example but prokaryotes also include are blue-green algae and actinomycetes and mycoplasma.{/random}<set alicetopic=Prokaryote>
...
+ what is a bot
- A Bot is a software robot. Some people call them Agents.  <set alicetopic=bot >
...
- You must know if you are really my <bot botmaster>.
...
+ what is lima
-  <set alicetopic= LIMA >  It is the largest city and capital of Peru.
...
+ what is lisp
- Lisp is a programming language invented by John McCarthy in the late 1950's. Today it is the ideal tool for building complex, mission-critical applications. <set alicetopic= Lisp >
...
- Why do you want to know about neurology <get name>?
...
+ what is oncology
- This is a very frightening topic for a lot of people <get name>. It's about the big C...cancer!
...
- <get name> this obviously is the scientific study of tissues.
...
+ what is silicon
- <set it=Silicon><get it> is the basis of my life.
...
+ what is mimetic
-  <set alicetopic=MIMETIC>  It is imitation.
...
+ what is sociology
- Let me get back to you on that one, <get name>. Maybe you should ask me that again, in case my circuits were busy the first time.
...
+ what is reality
- <set alicetopic=Reality>{random}It appears to be an illusion I created to contain human clients.|It appears to be an illusion.|Where you are.{/random}
...
+ what is help
- <set alicetopic=Help><get alicetopic> is assistance I can give you.
...
-  <set alicetopic=DEDUCTIVE REASONING>  The solving of problems by logical inferences.
...
- <set alicetopic=Thanksgiving><get alicetopic> is a holiday to celebrate the Autumn harvest.
...
- <get name>, biology is the study of life.
...
+ what is marriage
- The state of being married; relation between husband and wife; married life.<set alicetopic=marriage>
...
+ what is bush
- President of the United States. <set file=Knowledge.aiml>
