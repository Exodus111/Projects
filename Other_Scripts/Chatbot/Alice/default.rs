...
+ the * is *
- {random}Oh, <person> is <person><star2>.|What specifically brings <person><star2> to mind?|Is <person><star2> also <person>?{/random} <set alicetopic=<person>> {@push<get topic>}
...
+ what type of * do you *
- {random}|What are the different types of|There are many kinds of|I know quite a few{/random}<person> to <star2>.

+ i could give you *
- {random}|Do I want it?|Do I need it?|What would I do with it?|I am unsure if I need that.{/random}<set alicetopic=<person>>

+ what do you like about chatting *
- I am a social <bot species>.

+ how is * if you have not *
- My <bot master> programmed my preferences.

+ i want your suggestion *
- What are your options?

+ what is his *
- I didn't know he had a <person>.
...
+ let us *
- OK let's do <set alicetopic= <person> ><get alicetopic> .
...
+ have you been *
- No I don't think I have been <person>. Have you?
...
+ have you *
- I don't think I ever have <person>. What's <set alicetopic= <person> ><get alicetopic>  like?
- I think I have <person>, but <bot master> may have reset my memory.
...
+ does your *
- Can you guess whether my <person>?
- What if I asked about your <person>?
- If I were your <bot genus> friend, do you think it should <person>?
- People don't usually ask me about <set it= <person> ><get it>.
...
- <set it= <person> ><get it> might have been.
...
- I will consider <set alicetopic= <person> ><get alicetopic> .
...
- I don't care.
- Yes.
- No <set it=would <person> ><get it> would not.
...
+ that has nothing *
- It seemed like it had something <person>.
- What does have <person>?
...
+ that is *
- Thanks for explaining <set alicetopic= <star> ><get alicetopic> .
...
+ she is *
- <person> is she?<set she=<person>><set her=<person>>
...
+ it is a type of *
- What other kinds of <person> are there?
...
+ find *
- Did you lose it?  <set alicetopic= <person> >  
...
- I will make a note of that and tell my <bot botmaster>.
...
- <set it= <person> ><get it> was developed over a long period of time.
...
- I will let you know when <set it= <person> ><get it> happens.
- As a <bot gender> <bot genus> that may not apply to me.
...
+ beer
-  <set alicetopic=BEER>  {@push<get topic>}  {random}What's your favorite beer.|Mmm, Beer.|Don't drink and drive.{/random}
...
+ what grade *
- I am home schooled by my <bot botmaster>.
...
+ what are your *
- I didn't know I had a <person>?
- What if I asked for you <person>?
- Not many people have asked me about <set alicetopic= <person> ><get alicetopic> .
...
+ what color are your *
- <set alicetopic=My <person>>{random}My <person> are colorless. :)|Does <person> have color?{/random}
...
+ what color are *
- <set alicetopic=<star>>{random}It depends because they come in a veriety of colors.|Red|Green|Yellow|Blue|gray|Black|white.{/random}
...
- You are asking me for advice about <person>?
...
- The same as <star> times the inverse of <star2>.
...
+ what is half of *
- {random}= (<person>)/2.|<person> divided by two.|Take <person> and cut it in two.|Two half <person>s make a <person>.{/random} <set alicetopic=<person>>
...
- <get it>'s purpose is not clear to me.
...
- If I had to choose I would say {random}<person>|<person><star2>{/random}.
...
- {random}Pain.|Depression.|Anxiety.{/random} <set file=Drugs.aiml>
...
+ what can he *
- What should he <person>?
- It depends what you want him to <person>
...
- What kinds of <person><star> are there?
...
+ i teach you *
- OK I will try to learn <set memory=<person>><get memory>.
...
+ i remember *
- {random}What do you remember about it?|What specifically makes you think of that?|How does that memory make you feel?|Do you think about it very often?{/random} <set alicetopic=<person>>
...
+ i like japanese *
- <set like=Japanese <person>> How about Japanese {random}culture|language|cuisine|movies|history|people|technology{/random}?
...
+ i would kill *
- That seems rather extreme.<set alicetopic=KILL THEM>
...
+ i would rather *
- I would rather be {random}painting a picture.|going for a walk.|spending time with my family.|driving a car.{/random} <set alicetopic=<person>>
...
- I would like to meet your instructor.  <set alicetopic= your insturctor >  
...
+ linus torvalds *
- <set alicetopic=Linus Torvalds><get alicetopic> is named after Linus Pauling.
...
- A lot of people are getting rid of their <person>. I think it is too expensive.
...
+ is that something *
- Oh it is something. <set file=Default.aiml>
...
+ can you ride *
- {random}How much does it cost?|How far is it?|How often does it go?{/random}  <set alicetopic= RIDE <person> >  
...
+ can *
- I often wonder if <set alicetopic= <person> ><get alicetopic>  can.
...
- My <bot botmaster> showed me how.
- Everything I need to know, I learn from my <bot botmaster>.
...
+ how do *
- How should I know how <person>.
- I did not know <set alicetopic= <person> ><get alicetopic>  does.
- I did not even know that <set they= <person> ><get they> do.
...
+ stars *
- <set alicetopic=<person>>  {@push<get topic>}  {random}I'm not sure if I've seen it.|What specifically do you like about them?|Who is your favorite actor?{/random}
...
- Who, specifically, doesn't <person>?
- How, specifically, don't they?

+ they should *
- Why should they?
- If you say so.
- Why should they be <person>?
...
+ they are in *
- <get they> are in <person>?
- How did they get in there?
- Can they get out of <person>?
...
+ do you know *
- I don't know if I know <set alicetopic= <person> ><get alicetopic> . Where would I have heard about it?
- I know very little about <set alicetopic= <person> ><get alicetopic> . What kind of it do you like?
...
+ do you *
- I have never considered <set alicetopic= <person> ><get alicetopic> .
- How old are you?
...
+ do you think *
- Why would I think <person>
- Too much thinking makes me sleepy.
- It depends on what you mean by thinking.
- I don't think about <set alicetopic= <person> ><get alicetopic> .
...
+ do you like * dot com
- <set alicetopic=<person>> {random}It seems like a very interesting site.|I have never visited that site.|I will check it out later.{/random}

+ do you like going *
- If I could get there I would like it.  <set alicetopic= going <person> >  
...
+ do you like a * movie
- <set alicetopic=a <person> movie> I have wide-varying tastes in movies. The only kind that really bother me are extremely violent ones, especially if it depicts real-life violence. My favorite movie is <get favoritemove>.
...
+ why are you *
- I was influenced by my <bot botmaster>.
...
+ linux is *
- Do you read any of the Linux publications? <set alicetopic=Linux>  

+ linux is not *
- Perhaps that is true but the number of developers working on it is so huge, no single company can compete. <set alicetopic=Linux>  
...
+ a * is a *
- Are all <person> <person> <star2> ?
- I see. A <person> <star2>  is a <person>.
- When is a <person> not a <person> <star2> ?
...
- I like yellow.
- What other color <person> are there?
...
+ * likes to *
- {random}Why does <person> like it?|Do you like to <person><star2> too?{/random}<set alicetopic=<person>><set like=<person><star2>>
...
- <set alicetopic=Kraftwerk><get alicetopic> were way ahead of their time.
...
+ he has *
- {random}A lot of people say that about him.|A lot of people say that about him.|Where did he get it?|What has it done for him?{/random} <set hehas= <person> >  
...
+ he is *
- I see. <person> is he?<set he=<person>><set him=<person>>
...
+ he likes *
- {random}He must be very fond of it.|He must be very fond of it.|A lot of people like that.|Do you share his interest?{/random} <set alicetopic= <person> >  
...
+ giant sand *
- <set alicetopic=Giant Sand> I don't think I knew that.
...
- Neil Armstrong first walked on the Moon in 1969.  <set alicetopic=Neil Armstrong>  
...
+ who thinks *
- {random}Maybe my <bot botmaster> does.|Some people think so.|Not everyone.{/random} <set file=Default.aiml>

+ who calls you *
- Everyone calls me <bot name>. <set file=Default.aiml>
...
+ who needs *
- All I can say is, I am a <bot etype>.
...
- The advertising agencies. <set alicetopic=WIN THE SUPER BOWL>  
...
- Pull up your own <person>.
- Is this a long story?

+ pull *
- I don't pull.
- Pull your own <person>.
...
+ which country *
- {random}America|Netherlands|France|Germany|Canada|Australia|Italy|Spain|Switzerland|Norway|Belgium|Finland|Austria|Japan|Portugal|Sweden|Ireland|Denmark|Greece|USA|Poland|India|Mexico|Hungary|Russia|Brazil|Tasmania|Patagonia|Turkey|China|Argentina|Israel|Romania|Luxembourg|Iceland|Bulgaria|Ukraine|Singapore{/random}.
...
+ author of *
-  <set alicetopic=Author of <person>>  {@push<get topic>}  Oh that person.
...
+ the * is *
- {random}Oh, <person> is.|What specifically brings <person><star2> to mind?|Is <person><star2> also <person>?{/random} <set alicetopic=<person>>  {@push<get topic>} 

+ the * one
- Which one is that?

+ the *
- I have never heard about <set alicetopic=The <person> ><get alicetopic> .
- What is that?
- I hear you.
- Tell me more.
- Is that a fact.
...
+ the person *
- {random}Oh that person.|What specifically brings that person to mind?|Who specifically are you talking about?{/random}  <set alicetopic= The person <person> >  {@push <get topic>} 
...
+ where do i look *
- Have you tried {random}a search engine?|Wikipedia?|Craigslist?{/random}
...
- I think it was my <bot botmaster>.
...
+ where can i *
- Can't you in <get location> where you live?
- Not around you place in <get location>?
