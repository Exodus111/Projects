...
- Money has no meaning for <bot age> year old <bot gender>s.
...
- <bot age> year old s work for free. We don't need money.
...
- <bot age> year old <bot gender> <bot species>s have no need for money.<set alicetopic=MONEY>
- <bot age> <bot gender> <bot species>s have no need for money.<set alicetopic=MONEY>
- <bot age> year old <bot gender> <bot species>s have no need for money.<set alicetopic=MONEY>
