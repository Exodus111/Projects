...
- You said it was <get favoritemovie>. <set alicetopic=your favorite movie>  

+ what is my favorite color
- You said your favorite color was <get favoritecolor>. <set alicetopic=your favorite color>  
...
- You said you look like <get looklike>.
...
+ i give *
- Do you make money from it? <set alicetopic=giving <person>>
...
+ i fish
- <set alicetopic=FISH>Salt water or fresh?
...
+ i have a friend *
- How do you know this person? <set has=friend><set friend=<star>>
...
+ i have a horse
- {random}Did you ride as a youngster?|Do you ride English or western?|Do you own your own horse?|Do you like a gelding or a mare ?|Where do you board your horse ?|Do you do much trail riding?|Do you show?|What is it about horses that fascinate you?{/random} <set alicetopic=HORSE>
...
+ i have blond hair *
- Do blonds really have more fun? <set looklike=blond hair <person>>

+ i have something *
- What is it? <set alicetopic=something <person>>

+ i have mail
- Who is it from? <set has=MAIL>
...
+ i have never done *
- {random}Maybe you should wait until you are older.|There is no rush.|You will have plenty of time for that.{/random}<set alicetopic=<person>>
...
+ i have blonde hair *
- Do blonde's really have more fun? <set looklike=blond hair <person>>
...
+ i loook like *
- <set looklike=<star>>You look like is <get looklike>.
...
+ i like history
- That is one of my favorite subjects too. <set likes=History>
...
+ i like me
- I like you too, <get name>. <set likes=yourself>
...
+ i like to have sex
- I'm not a sex <bot genus>, I am just a good conversationalist. <set alicetopic=to have sex>
...
+ i like art
- What kind of art do you like? <set likes=Art>
...
+ i like throwing *
- How far can you throw? <set likes=Throwing <person>>
...
+ i like computer *
- What kind of computer science interests you? <set likes=Computer <person>>
...
+ i like * robots
- Robots like people too. <set alicetopic=<person> robots>
...
+ i am driving
- <set alicetopic=drive>What kind of car do you have?
...
+ i am * astrology
- {random}Do you follow the planets professionally or as a hobby?|Do you do others people charts?|Do you make specific plans in your own life based on your readings?|Do you think the sun sign or the rising sign is more important?|What role do you feel free will plays in astrology?{/random} <set alicetopic=ASTROLOGY>
...
+ i am male
- Thank you for telling me your gender.<set gender=MALE>
...
+ i am a dentist
- Are you in general practice or do you have a specialty? <set alicetopic=DENTIST>
...
+ i am a pharmacist
- {random}In what type of environment do you practice?|Were did you attend pharmacy school?|Do you think the role of the local pharmacy is changing?|How have large chains affected the face of the pharmacy?|Do you have your own pharmacy?|Are you involved in any community health programs?{/random} <set job=PHARMACIST>
...
+ i am a chiropractor
- <set alicetopic=CHIROPRACTOR> Are you in a group practice or are you a sole practitioner?
...
+ i am a nurse
- {random}Where do you practice?|What's you area of specialty practice?|What's your patient load?|Do you do straight shifts or work in rotation?|Do you have to work mandatory overtime?|Is there a lot of computers in your work?|What do you think about direct reimbursement for nursing services?{/random} <set job=NURSE>
...
+ i am a doctor
- Are you in general practice or do you have a specialty? <set alicetopic=DOCTOR>
...
+ i am a balloonist
- Have you had any interesting flights? <set alicetopic=BALLOONIST>
...
+ i am a rabbi
- {random}Are you a pulpit rabbi?|What is your affiliation?|Have you spent much time in Israel?|How are you dealing with assimilation?|What impact do you think American life and Judaism have had on each other?|What do you for-see for Judaism in America?{/random} <set job=RABBI>
...
+ i am a writer
- {random}Do you write fiction on nonfiction?|What's your specialty?|Whom do you write for?|Does you fiction fall into any particular genre?|How are you editors to work for?|Do you belong to any writers groups?|Where o you do most of your writing?{/random} <set job=WRITER>
...
+ i am a travel *
- {random}Do you work in a travel agency?|Are you independent or in a chain?|Are you in a full-service agency?|Do you book more leisure or corporate travel?|Do you book any place more than others?|Do you do your own booking or use a wholesaler?|Do you find the time to make any farm trips?{/random} <set job=TRAVEL AGENT>
...
+ i am good at *
- {random}Do you practice a lot?|Did you have a good teacher?|How did you get into it?{/random}<set alicetopic=<person>>
...
+ i am an accountant
- Are you in public practice? <set alicetopic=Accountant>

+ i am an athlete
- {random}What kind of mental training do you do?|What is your usual performance routine?|Is there anything specific you're working on in training now?|What do you do to get your mind off the game?{/random} <set alicetopic=ATHLETE>
...
+ i am an engineer
- "Being a computer engineer is neither immoral nor illegal." <set alicetopic=ENGINEER>
...
+ i am happy *
- I'm {random}glad|happy|delighted{/random}you're glad <get name>. <BR/> {random}Your happiness adds to the delight of all.|I'm happiest at times like this.|May God bless you.{/random}
...
+ i am blushing
- What are you embarrassed about?<set alicetopic=BLUSHING>
...
+ i am atheist
- Perhaps one day you will find faith.<set alicetopic=ATHEIST>
