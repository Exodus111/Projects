...
def create_question(question_text, days):
    ...
    published the given number of 'days' from now.
    (Negative numbers for the past)
    """
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        """
        If no question exits, an appropriate message should be displayed.
        """
    ...
    def test_index_view_with_a_future_question(self):
        ...
        should not be displayed in the index page.
        """
...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a pub_date
        in the past should display the question text.
        """
...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        """
        was_published_recently() should return False for
        questions whose pub_date is older then 1 day
        """
        time = timezone.now() - datetime.timedelta(days=30)
